...
class AccessibilityDisclosureDialog extends StatelessWidget {
  ...
  static Future<bool> show(BuildContext context) async {
    final result = await showModalBottomSheet<bool>(
      ...
      builder: (_) => const AccessibilityDisclosureDialog(),
    );
    return result ?? false;
  }
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      tx.accessibilityDisclosureTitle,
                    ...
                    Text(
                      tx.accessibilityDisclosureSubtitle,
          ...
          Container(
            ...
            child: Text(
              tx.accessibilityDisclosureBody,
          ...
          ElevatedButton(
            ...
            child: Text(
              tx.accessibilityDisclosureAgree,
              style: const TextStyle(
                fontSize: 16,
                fontWeight: FontWeight.w800,
              ),
          ...
          TextButton(
            ...
            child: Text(
              tx.accessibilityDisclosureCancel,
              style: const TextStyle(
                fontSize: 15,
                fontWeight: FontWeight.w700,
              ),
